...
<div class="container">
    ...
    <h2>🏭 行业板块资金净流入 TOP10</h2>
    {gen_table(['板块', '资金净流入(亿)', '散户净流入', '涨跌幅(%)'], 
               data['industry_top10'], 
               ['板块', '资金净流入', '散户净流入', '涨跌幅'])}

    <h2>📉 行业板块资金净流出 TOP10</h2>
    {gen_table(['板块', '资金净流入(亿)', '散户净流入', '涨跌幅(%)'], 
               data['industry_bottom10'], 
               ['板块', '资金净流入', '散户净流入', '涨跌幅'])}

    <h2>💡 概念板块资金净流入 TOP10</h2>
    {gen_table(['概念', '资金净流入(亿)', '散户净流入', '涨跌幅(%)'], 
               data['concept_top10'], 
               ['概念名称', '资金净流入', '散户净流入', '涨跌幅'])}

    <h2>⚠️ 概念板块资金净流出 TOP10</h2>
    {gen_table(['概念', '资金净流入(亿)', '散户净流入', '涨跌幅(%)'], 
