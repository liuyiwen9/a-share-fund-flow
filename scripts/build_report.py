...
<div class="container">
    ...
    {gen_table(['板块', '主力净流入(亿)', '散户净流入(亿)', '涨跌幅(%)'], data['industry_bottom10'], ['板块', '主力净流入', '散户净流入', '涨跌幅'])}

    <h2>💡 概念板块主力净流入 TOP10</h2>
    {gen_table(['概念', '主力净流入(亿)', '散户净流入(亿)', '涨跌幅(%)'], data['concept_top10'], ['概念名称', '主力净流入', '散户净流入', '涨跌幅'])}

    <h2>⚠️ 概念板块主力净流出 TOP10</h2>
    {gen_table(['概念', '主力净流入(亿)', '散户净流入(亿)', '涨跌幅(%)'], data['concept_bottom10'], ['概念名称', '主力净流入', '散户净流入', '涨跌幅'])}
